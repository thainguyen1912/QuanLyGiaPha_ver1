...
@WebServlet(name = "ListAvatar", urlPatterns = {"/ListAvatar"})
public class ListAvatar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd=request.getRequestDispatcher("views/management_page/list_avatar.jsp");
