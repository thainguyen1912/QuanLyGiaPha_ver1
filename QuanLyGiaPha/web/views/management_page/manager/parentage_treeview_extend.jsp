                                        ...
                                        <div style="float: left; width: 75%">
                                            ...
                                            <%
                                                ...
                                                for (int i = 0; i < arr_ind.size(); i++) {
                                                    ...
                                                    boolean check = true;
                                                    if (arr_ind.get(i).getAvatar() == null || arr_ind.get(i).getAvatar().equals("")) {
                                                        check = false;
                                                    }
                                            ...
                                            <div class="app-page-title1 ">
                                                <div class="page-title-icon1">
                                                    <div style="">
                                                        ...
                                                        %>
                                                        <img style="width: 100%" src="resources/images/<%=check == false ? "imagenotfound.png" : ind.getAvatar()%>" alt="your image" />
                                                    </div>
                                                    <hr style="width: 80%">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="gender" class="col-sm-8 col-form-label">
                                                            Giới Tính
                                                        </label>
                                                        <div class="col-sm-auto">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="childth" class="col-sm-8 col-form-label">
                                                            Con Thứ
                                                        </label>
                                                        <div class="col-sm-auto">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="wifeorhusbandname" class="col-sm-8 col-form-label">
                                                            Tên Vợ
                                                        </label>
                                                        <div class="col-sm-auto">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="datebirth" class="col-sm-8 col-form-label">
                                                            Ngày Sinh
                                                        </label>
                                                        <div class="col-sm-auto">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="datedeath" class="col-sm-8 col-form-label">
                                                            Ngày Mất
                                                        </label>
                                                        <div class="col-sm-auto">
                                                    ...
                                                    <div class="position-relative row form-group mb-1-1">
                                                        <label for="moreinfo" class="col-sm-8 col-form-label">
                                                            Thông Tin Thêm
                                                        </label>
                                                        <div class="col-sm-auto">
