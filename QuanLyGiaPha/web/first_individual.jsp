            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="Login" method="post">
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate="Bạn Chưa Nhập Tên">
                            <input class="input100" type="text" name="name" placeholder="Họ Và Tên">
                            <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Bạn Chưa Nhập Năm Sinh">
                            <input class="input100" type="text" name="datebirth" placeholder="Nhập Năm Sinh">
                            <span class="focus-input100"></span>
                        </div>
                        
                        <div class="wrap-input100 validate-input" data-validate = "Bạn Chưa Nhập Năm Mất">
                            <input class="input100" type="text" name="datedeath" placeholder="Nhập Năm Mất">
                            <span class="focus-input100"></span>
                        </div>
                        <div class="text-center p-t-13 p-b-23">
                            <p class="txt3">
